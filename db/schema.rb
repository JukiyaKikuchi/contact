...
ActiveRecord::Schema.define(version: 2022_12_09_024131) do
  ...
  create_table "parent_books", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "teacher_comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "parent_book_id", null: false
    t.text "teacher_comment", null: false
    t.string "teacher_name", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["parent_book_id"], name: "index_teacher_comments_on_parent_book_id"
